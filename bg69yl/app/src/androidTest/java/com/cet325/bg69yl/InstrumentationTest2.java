...
public class InstrumentationTest2 extends ActivityInstrumentationTestCase2<AddPlace> {

    private Activity mMainActivity;
    private EditText location;


    public InstrumentationTest2() {
    ...
    public void setUp() throws Exception {
        ...
        location = (EditText)mMainActivity.findViewById(R.id.LocationET);
